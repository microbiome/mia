...
test_that("getRareTaxa", {
    ...
    for( rank in ranks ){
        ...
        # Prevalent and rare taxa include only taxa from specified rank. all taxa
        # might include taxa from higher rank.
        all_taxa <- all_taxa[stringr::str_detect(all_taxa, rank)]
