...
#'
#' Chao A, Chun-Huo C, Jost L (2016). Phylogenetic Diversity Measures and Their Decomposition:
...
#' Good-Turing frequency formula. _Biometrics_ 70, 671-682.
#'
#' O'Hara, R.B. (2005). Species richness estimators: how many species can dance on the head
#' of a pin? _J. Anim. Ecol._ 74, 375-386.
#'
#' @seealso
