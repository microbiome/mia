...
#'     Simpson diversity (1/lambda) divided by observed species richness S:
#'     (1/lambda)/S.}
#'   \item{'pielou' }{Pielou's evenness (Pielou, 1966), also known as Shannon or
#'     Shannon-Weaver/Wiener/Weiner evenness; H/ln(S). The Shannon-Weaver is the
#'     preferred term; see Spellerberg and Fedor (2003).}
