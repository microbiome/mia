...
#'   If \code{add.col = NULL} no data will be added, if \code{add.col = TRUE} all 
#'   data will be added and if \code{add.col} is a \code{character} vector, it 
#'   will be used to subset to given column names in \code{colData}. (default:
#'   \code{add.col = NULL})
#'   
