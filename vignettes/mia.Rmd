...
```{r}
GlobalPatterns
GlobalPatterns <- makeTreeSummarizedExperimentFromPhyloseq(GlobalPatterns)
GlobalPatterns
```
...
```{r}
abund <- getAbundanceSample(tse, "CC1", abund_values = "counts")
all(abund == assay(tse, "counts")[,"CC1"])
abund <- getAbundanceFeature(tse, "522457", abund_values = "counts")
